...
let pkg = haskellngPackages.callPackage
            ({ mkDerivation, aeson, base, bytestring, classy-prelude
             ...
             , http-conduit, monad-control, monad-logger, mongoDB, persistent
             , persistent-mongoDB, persistent-template, resourcet, safe
             ...
             mkDerivation {
               ...
               buildDepends = [
                 ...
                 monad-logger persistent persistent-mongoDB persistent-template safe
               ...
               testDepends = [
                 base classy-prelude classy-prelude-yesod hspec monad-control
                 monad-logger mongoDB persistent persistent-mongoDB resourcet
                 shakespeare transformers yesod yesod-core yesod-test
               ];
